    ...
    <div class="card card-body mx-4 mb-4">
        <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
                <div class="h-100">
                    <h5 class="mb-1">Create Asset Type</h5>
                    <p class="mb-0 text-sm">Add a new asset type to the inventory system</p>
                </div>
            </div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('asset-types.store') }}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('name') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Laptop, Desktop, etc." id="name" name="name" value="{{ old('name') }}" required>
                                </div>
                                @error('name')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="@error('description') border border-danger rounded-3 @enderror">
                                    <textarea class="form-control" id="description" name="description" rows="3" placeholder="Detailed description of this asset type">{{ old('description') }}</textarea>
                                </div>
                                @error('description')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
