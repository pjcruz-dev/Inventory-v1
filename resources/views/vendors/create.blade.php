    ...
    <div class="card card-body mx-4 mb-4">
        <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
                <div class="h-100">
                    <h5 class="mb-1">Create Vendor</h5>
                    <p class="mb-0 text-sm">Add a new vendor to the inventory system</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            ...
                            <p class="text-sm mb-0">Fill in the details for the new vendor</p>
                        </div>
                        <div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" 
                                              ...
                                              name="address" 
                                              rows="3" 
                                              placeholder="Enter vendor address">{{ old('address') }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="3" 
                                              placeholder="Enter vendor description or notes">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              ...
                                              name="notes" 
                                              rows="3" 
                                              placeholder="Additional notes or comments about this vendor">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('vendors.index') }}" class="btn btn-light me-2">
