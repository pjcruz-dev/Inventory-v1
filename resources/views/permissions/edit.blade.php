        ...
        <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
                <div class="h-100">
                    ...
                    <p class="mb-0 text-sm">Modify permission details</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="@error('name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Permission Name" id="name" name="name" value="{{ $permission->name }}">
