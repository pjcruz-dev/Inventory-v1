    ...
    <div class="card card-body mx-4 mb-4">
        <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
                <div class="h-100">
                    <h5 class="mb-1">Permission Details</h5>
                    <p class="mb-0 text-sm">View permission information</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3 text-end">
                <a href="{{ route('permissions.edit', $permission->id) }}" class="btn bg-gradient-warning">
                    <i class="fas fa-edit"></i>&nbsp;&nbsp;Edit Permission
                </a>
                <a href="{{ route('permissions.index') }}" class="btn bg-gradient-dark">
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <p class="form-control-static">{{ $permission->created_at->format('F d, Y h:i A') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <label class="form-control-label">Roles with this Permission</label>
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    @if(count($roles) > 0)
                                    ...
                                    @else
                                        <div class="col-12">
                                            <p class="text-muted">No roles have this permission assigned.</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
